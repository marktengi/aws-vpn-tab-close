...
2. Either:
    - Download the zip of the [latest release](https://github.com/marktengi/aws-vpn-tab-close/releases) and just drag it onto the extensions page (you may need to refresh the page after enable developer mode if it tries to download the zip); or
